...
export default [
  ...
  },
  {
    ...
    contents: [
      ...
      {
        preface: '\'네트워킹 구성\' 단계',
        text: '\'네트워킹 구성\' 단계에서는 특별히 지시된 내용이 없으므로 바로 다음 버튼을 누른다.',
        image: require('./assets/practical-1/7.png').default,
      },
      {
        preface: '\'가상 하드 디스크 연결\' 단계',
        text: '문제에서 제시된 대로 가상 하드 디스크의 이름과 위치, 크기를 입력한 후 다음 버튼을 누른다.',
        image: require('./assets/practical-1/8.png').default,
      },
      {
        preface: '\'설치 옵션\' 단계',
        text: '문제 지시 사항대로, \'나중에 운영 체제 설치\' 옵션을 눌러 준다.',
        image: require('./assets/practical-1/9.png').default,
      },
      {
        preface: '\'요약\' 단계',
        text: '입력했던 정보들로 생성된 가상 컴퓨터에 대한 정보가 표시된다.',
        image: require('./assets/practical-1/10.png').default,
      },
      {
        preface: '끝',
        text: '생성한 가상 컴퓨터가 가상 컴퓨터 목록에 보이는 것을 확인할 수 있다.',
